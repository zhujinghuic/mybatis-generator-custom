 ...
 * 
 */
public class BatchInsertSelectiveElementGenerator extends
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", introspectedTable.getBatchInsertSelectiveStatementId())); //$NON-NLS-1$
...
//                    answer.addElement(getSelectKey(introspectedColumn, gk));
        ...
        forEeachElement.addElement(insertTrimElement);
