 ...
 * 
 */
public class BatchInsertOrUpdateSelectiveElementGenerator extends
        AbstractXmlElementGenerator {

    public BatchInsertOrUpdateSelectiveElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", introspectedTable.getBatchInsertOrUpdateSelectiveStatementId())); //$NON-NLS-1$
...
//                    answer.addElement(getSelectKey(introspectedColumn, gk));
        ...
        forEeachElement.addAttribute(new Attribute("item", "item")); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        forEeachElement.addElement(valuesTrimElement);
        ...
        for (IntrospectedColumn introspectedColumn : ListUtilities.removeIdentityAndGeneratedAlwaysColumns(introspectedTable
            ...
            notNullElement.addAttribute(new Attribute(
                    "test", sb.toString())); //$NON-NLS-1$
            ...
            updateTrimElement.addElement(notNullElement);
        }
