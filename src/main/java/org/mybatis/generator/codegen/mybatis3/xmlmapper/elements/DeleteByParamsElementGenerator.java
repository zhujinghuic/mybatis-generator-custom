 ...
 * 
 */
public class DeleteByParamsElementGenerator extends
        AbstractXmlElementGenerator {

    private boolean isSimple;

    public DeleteByParamsElementGenerator(boolean isSimple) {
        super();
